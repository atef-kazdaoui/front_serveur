...
<div className="container-affclient">


<div className="liste-client">
  <h3 style={{color:'black'}}>Nos clients</h3>
  <Table striped bordered hover>
    ...
    {clients.client && clients.client.map(client => (
        ...
        <td><button type="button" class="btn btn-success" onClick={() => handleacces(client)}>donner acces admin</button></td>
